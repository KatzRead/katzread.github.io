...
async function loadWidget(){
  try{
    ...
    if(matchCount>0){
      ...
      avgRow.innerHTML=`<td colspan="5" style="text-align:center;font-weight:bold;#00ffff;text-shadow:0 0 1px #00ffff;border-top:1px solid #00ffff;padding-top:6px;">AVG — ${avgKills} / ${avgDeaths} / ${avgKD} / ${avgADR} / ${avgHS}</td>`;
