...
// Tema rengi (global: tüm sayfalarda aynı çalışır)
...
async function loadWidget(){
  try{
    ...
    if(matchCount>0){
      ...
      avgRow.innerHTML=`<td colspan="5" style="text-align:center;font-weight:bold;color:var(--theme-color);text-shadow:0 0 1px var(--theme-color);border-top:1px solid var(--theme-color);padding-top:6px;">AVG — ${avgKills} / ${avgDeaths} / ${avgKD} / ${avgADR} / ${avgHS}</td>`;
